...
var submitQuestion = document.getElementById('GenerateVideoLinksBtn');
submitQuestion.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var userInput, prompt, videoLinks, responseText;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      ...
      case 4:
        prompt = "\n        Provide YouTube video links (URLs) for the following topic: \"".concat(userInput, "\". \n        List 5 relevant videos, each on a separate line.  Do not include anything other than the URLs.\n\t\tIf you can't find 5 suitable videos, provide as many as possible.\n\t\tReturn ONLY the URLs.\n\t\t");
        _context.prev = 5;
        _context.next = 8;
        return executePrompt(prompt);
      case 8:
        videoLinks = _context.sent;
        responseText = document.getElementById('videoDetails');
        if (responseText) {
          videoContainer.innerHTML = "\n                <h2>YouTube Video Links for: ".concat(userInput, "</h2>\n                <ol>\n                    ").concat(responseText, "\n                </ol>\n            ");
        } else {
          videoContainer.innerHTML = "No relevant YouTube video links found for \"".concat(userInput, "\".");
        }
        _context.next = 17;
        break;
      case 13:
        ...
        console.error('Error generating video links:', _context.t0);
        videoContainer.innerHTML = "Error: ".concat(_context.t0.message);
      case 17:
      case "end":
  ...
  _executePrompt = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(prompt) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          apiKey = "AIzaSyB1rICUSO4GYdpzY-dkX_kcdRubBplApCI"; // Replace with your API key
        ...
        case 14:
          ...
          console.error('Error processing request with Gemini AI:', _context2.t0);
          throw _context2.t0;
        case 18:
        case "end":
